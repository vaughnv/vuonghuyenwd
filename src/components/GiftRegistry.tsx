...
export default function GiftRegistry() {
  const [selectedBank, setSelectedBank] = useState<'groom' | 'bride' | null>(null);

  return (
    <div id="card-banks" style={{ order: 11 }}>
        <div className="qr-button-section">
            <FadeIn direction="up">
                <button className="qr-gift-button mb-4" onClick={() => setSelectedBank('groom')}>
                    <Gift className="mr-2" /> Quà mừng cưới chú rể
                </button>
            </FadeIn>
            <FadeIn direction="up" delay={0.2}>
                <button className="qr-gift-button" onClick={() => setSelectedBank('bride')}>
        ...
        {selectedBank && (
            <div className="qr-modal show" onClick={(e) => { if(e.target === e.currentTarget) setSelectedBank(null); }}>
                <div className="qr-modal-content">
                    <button className="qr-modal-close" onClick={() => setSelectedBank(null)}>
                        <X />
                    </button>
                    ...
                    <div className="qr-modal-body">
                        <div className="qr-cards justify-center">
                            {selectedBank === 'groom' && (
